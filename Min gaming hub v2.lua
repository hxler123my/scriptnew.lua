 loadstring(game:HttpGet(('https://raw.githubusercontent.com/phuong/tiktok/main/source')))()

local Window = OrionLib:MakeWindow({Name = "PhuongDz | Demo ", HidePremium = false, SaveConfig = true, ConfigFolder = "Orion"})
